...
# Processing Steps
*Preconditions* The run_analysis script assumes it is started in a directory containing itself and the prettyNames.R file. It assumes the raw data is unzipped into a subdirectory titled "data/UCI HAR Dataset/".
